...
namespace moredrill.items
{
    public class silverdrill : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.useTurn = true;
            Item.shoot = ModContent.ProjectileType<Projectiles.silverdrillproj>();            //расположение ПРОДЖЕКТАЙЛА (следующий гайд)</span>
            Item.shootSpeed = 32f;
            Item.noMelee = true;
            Item.channel = true;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.SilverBar, 19);// Компоненты рецепта
